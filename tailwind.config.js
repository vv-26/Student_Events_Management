  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "mesh":            "radial-gradient(at 40% 20%, #5B2EFF22 0px, transparent 50%), radial-gradient(at 80% 0%, #A855F722 0px, transparent 50%), radial-gradient(at 0% 50%, #7c3aed22 0px, transparent 50%)",
      },
    },
  },
  plugins: [],
