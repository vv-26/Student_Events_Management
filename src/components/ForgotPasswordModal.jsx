...
// Modal popup for password reset — glassmorphism style
...
export default function ForgotPasswordModal({ isOpen, onClose, onSubmit }) {
  ...
  return (
    ...
    >
      ...
      <div
        className="glass rounded-2xl border border-white/10 p-8 w-full max-w-md shadow-glow-lg animate-slide-up"
        ...
        {!sent ? (
          <>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <GradientButton variant="ghost" onClick={handleClose} className="w-full text-center">
                Cancel
              </GradientButton>
            </form>
          </>
          ...
          <div className="text-center py-4">
            ...
            <p className="text-sm text-white/50 mb-6">
              Reset instructions sent to <span className="text-violet-300">{email}</span>
            </p>
