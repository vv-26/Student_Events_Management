// src/components/BrandPanel.jsx
// Left-side branding panel for auth pages

/**
 * BrandPanel
 * Shows logo, tagline, stats, and decorative orbs
...
export default function BrandPanel() {
  ...
  return (
    <div className="relative hidden lg:flex flex-col justify-between h-full p-12 overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[200px] h-[200px] rounded-full bg-purple-600/10 blur-[60px] pointer-events-none" />
      ...
      <div className="space-y-8">
        <div className="animate-slide-left anim-hidden delay-200">
          <h1 className="font-display text-4xl font-bold leading-tight text-white">
            Manage events.
            <br />
            <span className="text-transparent bg-clip-text bg-brand-gradient2">
              Empower students.
            </span>
          </h1>
          <p className="mt-4 text-white/50 text-base leading-relaxed max-w-sm">
            The all-in-one platform for faculty to organize events, track student
        ...
        <div className="space-y-3 animate-slide-left anim-hidden delay-300">
          {features.map((f, i) => (
            <div key={i} className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-lg glass border border-white/10 flex items-center justify-center text-sm flex-shrink-0">
                {f.icon}
              </div>
