...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Faculty data to pass to dashboard
    const facultyData: FacultyData = {
      facultyId: "F001",
      facultyName: form.email,
    };
    ...
    // Navigate to FacultyDashboard and pass facultyData via route state
    setTimeout(() => navigate("/faculty/dashboard", { state: { facultyData } }), 1600);
  };
